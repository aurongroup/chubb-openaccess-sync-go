...
import (
	...
	"io"
	"log"
	datacsv "openaccess-sync/data/csv"
...
func ParseCSV(path string) (*datacsv.AccessRecordCache, error) {
...
func PrintCSVReport(records []*model.AccessRecord, path string) error {
